...
class ScNet(nn.Module):
    ...
    def forward(self, original_image):
        ...
        output_sc_FcLayer1 = torch.tensor(ScCudaTorch.ScCudaFcLayer(sc_flattened_list, self.new_weightsfc3, self.new_biasfc3, self.new_INPUTfc_rndomMatrix3, self.new_weightsfc_rndomMatrix3, self.new_biasfc_rndomMatrix3, self.noOutputs3, bitstream_Length))
        ...
        output_sc_FcLayer2 = torch.tensor(ScCudaTorch.ScCudaFcLayer(output_sc_FcLayer1_tensor_norm, self.new_weightsfc4, self.new_biasfc4, self.new_INPUTfc_rndomMatrix4, self.new_weightsfc_rndomMatrix4, self.new_biasfc_rndomMatrix4, self.noOutputs4, bitstream_Length))
        ...
        output_sc_FcLayer3 = torch.tensor(ScCudaTorch.ScCudaFcLayer(output_sc_FcLayer2_tensor_norm, self.new_weightsfc5, self.new_biasfc5, self.new_INPUTfc_rndomMatrix5, self.new_weightsfc_rndomMatrix5, self.new_biasfc_rndomMatrix5, self.noOutputs5, bitstream_Length))
...
print("UNIPOLARS COMPACT", bitstream_Length)
...
new_weightsfc3 = torch.flatten(net.fc1.weight.data.t(), 0)
...
new_weightsfc4 = torch.flatten(net.fc2.weight.data.t(), 0)
...
new_weightsfc5 = torch.flatten(net.fc3.weight.data.t(), 0)
...
class_name = 'Sneaker'
print("UNIPOLARS COMPACT: ", class_name, bitstream_Length)
